...
const Settings = () => {
    ...
    const fetchAdminData = async () => {
       ...
       */
                 ...
                 */
                setStats({
                    totalMembers: data.data.stats.totalMembers || 0,
                    pendingApprovals: data.data.stats.pendingApplications || 0,
                    approved: data.data.stats.approvedApplications || 0,
                    rejected: data.data.stats.rejectedApplications || 0
                });
            }
        } catch (error) {
