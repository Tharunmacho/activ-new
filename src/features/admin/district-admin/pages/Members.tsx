...
import { Search, Filter, Users, Mail, Phone, MapPin, CheckCircle, XCircle } from "lucide-react";
...
// `Tabs` / `TabsList` / `TabsTrigger` are used in the render below but were
// never imported, so this page threw a ReferenceError as soon as it mounted.
// The state-admin copy of the same screen imports them; this one was missed.
...
const Members = () => {
  ...
  // Fetch real member data from dashboard
  useEffect(() => {
