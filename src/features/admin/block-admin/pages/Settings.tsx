    ...
    const fetchAdminData = async () => {
        try {
            ...
            if (statsResponse.ok) {
                ...
                /**
                 * The tier dashboard nests its figures under `data.stats`,
                 * alongside `applicants` and `recentActivities`. Reading them off
                 * `data` directly found nothing, and `|| 0` turned every miss into
                 * a confident zero.
                 */
                    setStats({
                        totalMembers: statsData.data.stats.totalApplications || 0,
                        pendingApprovals: statsData.data.stats.pendingApplications || 0,
                        approved: statsData.data.stats.approvedApplications || 0,
                        rejected: statsData.data.stats.rejectedApplications || 0
                    });
                }
            }
        } catch (error) {
        ...
        <div className="min-h-screen flex bg-gradient-to-br from-gray-100 to-gray-50">
            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="md:hidden flex items-center justify-between p-4 bg-white border-b shadow-sm">
                    ...
                    <Avatar 
                        className="w-10 h-10 ring-2 ring-blue-100 cursor-pointer hover:ring-blue-300 transition-all"
                        onClick={() => setProfileModalOpen(true)}
                    >
                        {adminInfo?.avatarUrl ? (
                            <AvatarImage src={adminInfo.avatarUrl} className="object-cover" />
                        ) : (
                        ...
                        <div className="max-w-6xl mx-auto pt-12 lg:pt-0">
                            ...
                            <div className="mb-8">
                                <div className="flex flex-col md:flex-row items-center md:items-start gap-4 text-center md:text-left">
                                    <Avatar 
                                        className="w-20 h-20 ring-4 ring-blue-100 cursor-pointer hover:ring-blue-300 transition-all"
                                        onClick={() => setProfileModalOpen(true)}
                                    >
                                        {adminInfo?.avatarUrl ? (
                                            <AvatarImage src={adminInfo.avatarUrl} className="object-cover" />
