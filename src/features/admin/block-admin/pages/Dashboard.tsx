                ...
                <div className="space-y-3">
                  {recentApplications.length > 0 ? (
                    recentApplications.map((app) => {
                      const displayName = app.fullName || app.personalFormId?.name || app.userId?.fullName || 'Unknown';
                      const displayInitials = displayName !== 'Unknown' ? displayName.split(' ').map((n: string) => n[0]).join('').slice(0, 2).toUpperCase() : 'N/A';
