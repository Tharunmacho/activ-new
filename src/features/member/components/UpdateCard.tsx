    ...
    return (
        ...
        >
            ...
            <div className="p-4 lg:p-5">
                ...
                <h3 className={`${CARD_TITLE} text-slate-900 group-hover:text-blue-700 transition-colors`}>
                    {update.title}
                </h3>
                ...
                {update.attachmentUrl ? (
                    <p className="mt-2.5 inline-flex items-center gap-1.5 text-[1.0625rem] font-semibold text-blue-600">
